...
<head>
    ...
    @if(file_exists(public_path('hot')))
        @vite(['resources/views/vendor/dochub/workspace/analyze/analyze.ts'])
    @elseif (file_exists(public_path('vendor/dochub/manifest.json')))
        @vite(['view/src/workspace/analyze/analyze.ts'], 'vendor/dochub')
    @else
...
<body>
  <div class="card">
      <div class="card-header">
          <h2 class="title">Analayze Folder</h2>
          <p>Generating manifest of your project path</p>
      </div>
      <div class="card-body" id="analyze-app">
      </div>
  </div>
  <!-- Status Section -->
